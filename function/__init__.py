...
def main(mytimer: func.TimerRequest) -> None:
    ...
    blob_client_json = blob_service_client.get_blob_client(
        container=container_name, blob=json_file_name
    )
    ...
    # Upload MLD diagram
    blob_client_diagram_mld = blob_service_client.get_blob_client(
        container=container_name, blob=diagram_file_name_MLD
    )
    ...
    # Upload HLD diagram
    blob_client_diagram_hld = blob_service_client.get_blob_client(
        container=container_name, blob=diagram_file_name_HLD
    )
